...
export const HomeContainer = ({
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto my-4 space-y-6 xl:px-12">
        {updatedResourceData?.length > 0 && (
          <section className="space-y-6">
            <div className="flex items-center space-x-4">
              <h2 className="text-lg font-bold lg:text-2xl">最新动画</h2>
              <Button
                variant="light"
                as={Link}
                color="primary"
        ...
        {commentsData?.length > 0 && (
          <section className="space-y-6">
            <h2 className="text-lg font-bold lg:text-2xl">最新评论</h2>
