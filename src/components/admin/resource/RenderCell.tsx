      ...
      return (
        <div>
          <Badge
            ...
            showOutline={false}
            isInvisible={
              !(resource.dbId.startsWith('a') && resource.status === 1)
            }
            content={'完结'}
          >
            <Image
        ...
        >
          ...
          <p
            className={cn(
              ...
              getResourceTypeByDbId(resource.dbId) === 'anime' && 'text-primary'
            )}
          >
            {
              TYPE_CHINESE_MAP[
    ...
    case 'actions':
      return (
        <div className="flex items-center gap-2">
          <ResourceEdit initialResource={resource} onUpdate={onUpdate} />
          <ResourceDelete resource={resource} onDelete={onDelete} />
        </div>
      )
    case 'status':
      return (
