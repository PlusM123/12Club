        ...
        case 'name':
            return (
                <div className="flex flex-col gap-1">
                    <Link href={getRouteByDbId(item.resourceDbId)} target="_blank" rel="noopener noreferrer">
                        <p className="font-semibold hover:text-primary">{item.resourceName}</p>
                    </Link>
        ...
        case 'actions':
            return (
                <div className="flex gap-2">
                    <Link href={`/admin/resource?query=${item.resourceDbId}`} target="_blank" rel="noopener noreferrer">
