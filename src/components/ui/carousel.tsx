        ...
        >
          ...
          <div className="flex justify-center">
            {href ? (
              <Link
                href={href}
                className="mt-6 w-fit mx-auto text-white text-3xl flex justify-center items-center rounded-full hover:shadow-lg transition duration-200"
              >
                <FaPlay />
              </Link>
            ) : (
              <button className="mt-6 w-fit mx-auto text-white text-3xl flex justify-center items-center rounded-full hover:shadow-lg transition duration-200">
                <FaPlay />
              </button>
            )}
          </div>
...
export default function Carousel({ slides }: CarouselProps) {
  ...
  return (
    <div
      className={cn('relative aspect-[3/4]', widthClassName)}
    ...
    >
      ...
      <div className="absolute flex 2xl:hidden justify-center w-full top-full mt-5">
        <CarouselControl
          type="previous"
