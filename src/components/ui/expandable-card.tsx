...
export function ExpandableCard( { cards } : {cards: cards} ) {
  const [active, setActive] = useState<(typeof cardList)[number] | boolean | null>(
    null
  );
  const id = useId();
  ...
  return (
    <>
      ...
      <ul className="max-w-2xl mx-auto w-full grid grid-cols-1 md:grid-cols-4 items-start gap-4">
