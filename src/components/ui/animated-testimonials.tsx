      ...
      <div className="relative grid grid-cols-1 md:grid-cols-2 gap-24">
              ...
              {testimonials.map((testimonial, index) => (
                ...
                >
                  <Image
                    ...
                    height={900}
                    draggable={false}
                    className="h-full rounded-xl object-cover object-center shadow-xl"
                  />
                </motion.div>
              ))}
            </AnimatePresence>
        ...
        <div className="flex justify-between flex-col py-4">
          ...
          >
            ...
            <motion.p className="text-lg text-gray-500 mt-8 dark:text-neutral-300 max-h-[50vh] overflow-y-hidden">
