...
可能因為緊張的關係，我感覺自己表情緊繃。 
`,
          title: "你不敢吻我對吧？」自大的青梅竹馬挑釁我，結果她比我想像中更容易害羞",
          author: "樱木樱",
          src: "/novel/2.jpg",
          ctaLink: "/novel/2",
        },
...
「沒人問你這件事的進展啊……二郎。」 `,
          title: "我和隔壁班美少女共度甜蜜校園生活，但事到如今實在無法承認當初搞錯了告白對象",
          author: "サトウとシオ",
          src: "/novel/3.jpg",
          ctaLink: "/novel/3",
        },
        {
          quote:
          `萊特等人的下一個復仇目標是矮人族的納諾。為了打倒他，萊特向矮人王國尋求合作，矮人國王達干則提出要求，希望他們攻略太古時代滅亡的『過去文明』遺跡。 
